<x-layout>
    ...
    <div class="relative h-[600px] bg-gray-900 overflow-hidden">
        ...
        <div class="absolute inset-0 bg-gradient-to-br from-black/70 via-safari-deep-green/50 to-black/70"></div>
        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            <div class="w-full lg:w-2/3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                    @if($tour->includes)
                    <div class="bg-white rounded-3xl p-8 shadow-2xl border-2 border-emerald-200">
                        <div class="flex items-center gap-3 mb-6">
                            <span class="text-3xl">✅</span>
                            <h3 class="font-black text-2xl text-emerald-700">What's Included</h3>
                        </div>
                        <ul class="space-y-3">
                            @foreach($tour->includes as $item)
                                <li class="flex items-start gap-3 text-gray-700 font-medium">
                                    <svg class="w-6 h-6 text-emerald-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg>
                                    <span>{{ $item }}</span>
                                </li>
                            @endforeach
                        </ul>
            ...
            <div class="w-full lg:w-1/3">
                <div class="bg-white rounded-3xl p-8 shadow-2xl sticky top-28 border-2 border-safari-gold/30">
                    ...
                    <form x-data="{ 
                        ...
                        <button type="submit" :disabled="loading" class="w-full bg-gradient-to-r from-green-500 to-green-600 text-white py-4 rounded-2xl font-black hover:shadow-2xl transition-all flex items-center justify-center gap-3 disabled:opacity-50 transform hover:scale-105 text-lg">
